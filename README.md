...
نظام لتسجيل وتحليل هدر الطعام في المطابخ التجارية. يتكون المستودع من API مركزي، وصفحة هبوط، وتطبيق Kiosk للعامل، ولوحة تحليلات. يدعم التشغيل المحلي السريع عبر SQLite أو التشغيل متعدد المطاعم والفروع عبر Supabase.

تدعم لوحة التحكم وتطبيق الكيوسك اللغات العربية والفرنسية والإنجليزية، مع حفظ اختيار اللغة محليًا وتغيير اتجاه الواجهة تلقائيًا.
...
يشغّل هذا الأمر فحص الكود والاختبارات وبناء جميع التطبيقات.
